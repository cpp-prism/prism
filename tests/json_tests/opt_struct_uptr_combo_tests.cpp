...
TEST_CASE("prismJson - my_opt_struct and my_uptr_sub together round trip", "[json][optional][unique_ptr][combo]")
{
    SECTION("both my_opt_struct and my_uptr_sub populated round trip")
    {
        tst_struct obj;
        obj.my_int = 1;
    ...
    SECTION("my_opt_struct null, my_uptr_sub populated round trip")
    {
        tst_struct obj;
        obj.my_int = 2;
        obj.my_list_int.clear();
    ...
    SECTION("my_opt_struct populated, my_uptr_sub null round trip")
    {
        tst_struct obj;
        obj.my_int = 3;
        obj.my_list_int.clear();
