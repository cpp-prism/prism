...
TEST_CASE("prismJson - tst_sub_struct vec_sp with bool and string fields round trip", "[json][sub_struct][vec_sp][bool][string]")
{
    SECTION("vec_sp element with bool true and non-empty string round trip")
    {
        tst_struct obj;
        obj.my_int = 1;
    ...
    SECTION("vec_sp two elements mixing bool true and false round trip")
    {
        tst_struct obj;
        obj.my_int = 2;
        obj.my_list_int.clear();
    ...
    SECTION("vec_sp element with empty string and false bool round trip")
    {
        tst_struct obj;
        obj.my_int = 3;
        obj.my_list_int.clear();
