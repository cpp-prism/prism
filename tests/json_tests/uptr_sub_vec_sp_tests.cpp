...
TEST_CASE("prismJson - my_uptr_sub alongside vec_sp round trip", "[json][uptr][vec_sp][combo]")
{
    SECTION("my_uptr_sub set and vec_sp populated round trip")
    {
        tst_struct obj;
        obj.my_int = 1;
    ...
    SECTION("my_uptr_sub null and vec_sp empty round trip")
    {
        tst_struct obj;
        obj.my_int = 2;
        obj.my_list_int.clear();
    ...
    SECTION("my_uptr_sub with nested string alongside vec_sp two elements round trip")
    {
        tst_struct obj;
        obj.my_int = 3;
        obj.my_list_int.clear();
