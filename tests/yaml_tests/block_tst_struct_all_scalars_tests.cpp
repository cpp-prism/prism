...
TEST_CASE("prismYaml - block format tst_struct all scalar fields set simultaneously round trip", "[yaml][block][tst_struct][scalar][all]")
{
    SECTION("all scalar fields positive values block round trip")
    {
        tst_struct obj;
        obj.my_int = 42;
        obj.my_bool = true;
        ...
        obj.my_string = "block_all_scalars";
        obj.my_opt_str = "block_opt";
        obj.my_opt_int = 77;
        ...
        REQUIRE(result->my_string == "block_all_scalars");
        REQUIRE(result->my_opt_str.has_value());
        REQUIRE(result->my_opt_str.value() == "block_opt");
    ...
    SECTION("all scalar fields null/negative block round trip")
    {
        tst_struct obj;
        obj.my_int = -99;
        obj.my_bool = false;
