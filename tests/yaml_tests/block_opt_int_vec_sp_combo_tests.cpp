...
TEST_CASE("prismYaml - block format my_opt_int in sub_struct within vec_sp round trip", "[yaml][block][opt_int][vec_sp][combo]")
{
    SECTION("vec_sp sub_struct with opt_int set block round trip")
    {
        tst_struct obj;
        obj.my_int = 1;
    ...
    SECTION("vec_sp sub_struct with opt_int null block round trip")
    {
        tst_struct obj;
        obj.my_int = 2;
        obj.my_list_int.clear();
    ...
    SECTION("standalone opt_int with vec_sp sub_struct opt_int block round trip")
    {
        tst_struct obj;
        obj.my_int = 3;
        obj.my_list_int.clear();
